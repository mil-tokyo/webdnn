...
declare namespace WebDNN {
    interface ArrayLikeWithSlice {
        [index: number]: number;
        length: number;
        slice(): ArrayLikeWithSlice;
    }
    namespace Math {
        /**
         ...
         */
        function argmax(arr: ArrayLikeWithSlice, k?: number): number[];
        /**
         ...
         */
        function argmin(arr: ArrayLikeWithSlice, k?: number): number[];
    }
}
declare namespace WebDNN {
    /**
