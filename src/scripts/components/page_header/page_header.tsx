...
import { AnchorID as AboutAnchorID } from "../about_section/about_section";
import { AnchorID as BenchmarkAnchorID } from "../benchmark_section/benchmark_section";
import { AnchorID as CompatibilityAnchorID } from "../browser_compatibility_section/browser_compatibility_section";
import { AnchorID as ExampleSectionAnchorID } from "../neural_style_transfer_example_section/neural_style_transfer_example_section";
    ...
    <header className={classNames(style.pageHeader, props.className)}>
        ...
        <div className={style.itemContainer}>
            ...
            <p className={style.link}>
                <a href="/webdnn/ja"><span>日本語</span></a>
