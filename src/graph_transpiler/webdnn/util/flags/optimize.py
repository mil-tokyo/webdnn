...
SIMPLIFY_ELEMENTWISE_PARALLEL = os.environ.get("SIMPLIFY_ELEMENTWISE", "1") == "1"
SIMPLIFY_ELEMENTWISE_SEQUENTIAL = os.environ.get("SIMPLIFY_ELEMENTWISE", "1") == "1"
MERGE_ELEMENTWISE = os.environ.get("MERGE_ELEMENTWISE", "1") == "1"
REMOVE_LAST_SOFTMAX = os.environ.get("REMOVE_LAST_SOFTMAX", "0") == "1"
