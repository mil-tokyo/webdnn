...
@WebGPUDescriptorGenerator.register_handler(AxiswiseBias)
...
#define FLAG_D3_EQUAL_1 %%FLAG_D3_EQUAL_1%%
    ...
    const device float *X = %%LOAD_BUFFER(axiswise_bias_X)%%;
    const device float *B = %%LOAD_BUFFER(axiswise_bias_B)%%;
