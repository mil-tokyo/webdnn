...
[Depth2Space] Input variable "x" must has "spatial_axis1", "spatial_axis2", "depth_axis":
    (x) = {x}
...
"""
    ...
    def exec(self):
        ...
        assert x.shape_dict[self.depth_axis] % (self.r * self.r) == 0, f"""
[Depth2Space] The size of depth axis in input variable must be divisible by r*r:
    (x) = {x}
    (depth axis) = {self.depth_axis} 
    (r*r) = {self.r*self.r}
"""
