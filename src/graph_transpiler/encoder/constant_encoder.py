...
class ConstantEncoder:
    ...
    def get_encoder(cls, name: str = None) -> "ConstantEncoder":
        from graph_transpiler.encoder.constant_encoder_raw import ConstantEncoderRaw
        from graph_transpiler.encoder.constant_encoder_eightbit import ConstantEncoderEightbit
