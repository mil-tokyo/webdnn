...
from graph_transpiler.backend.webassembly.operators.col2im import Col2Im as WasmCol2Im
from graph_transpiler.backend.webgpu.operators.col2im import Col2Im as WebGPUCol2Im
