...
def test():
    link = chainer.links.Deconvolution2D(4, 10, ksize=3, stride=1, pad=1)
    ...
    generate_kernel_test_case(
        description=f"[chainer] L.Deconvolution2D",
        graph=graph,
...
def test_nobias():
    link = chainer.links.Deconvolution2D(4, 10, ksize=3, stride=1, pad=1, nobias=True)
